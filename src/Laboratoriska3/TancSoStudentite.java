...
public class TancSoStudentite {
    ...
    public static Semaphore maski = null;
    public static Semaphore zenski = null;
    public static Semaphore tancuvaj = null;
    public static Semaphore imaPar = null;
