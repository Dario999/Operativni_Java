...
public class SeptemberTribeDinner {
    ...
    static Semaphore check = null;
    static Semaphore eat = null;
    static Semaphore cook = null;
    static Semaphore potFull = null;

    public static void init() {
        check = new Semaphore(1);
        eat = new Semaphore(4);
        cook = new Semaphore(0);
        potFull = new Semaphore(0);
    }
