...
public class MusicBand {
    ...
    public static Semaphore singer = null;
    public static Semaphore guitar = null;
    public static Semaphore play = null;
    public static Semaphore ready = null;
    public static Semaphore done = null;
    public static Semaphore finish = null;
    public static Semaphore lock = null;
    public static int GuitaristHere;
